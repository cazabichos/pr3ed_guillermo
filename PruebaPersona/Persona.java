 ...
 */
package pruebapersona;  //Este comentario forma parte de la práctica
...
public class Persona {
	...
	public Persona() {
		// System.out.println("SE EST� EJECUTANDO EL CONSTRUCTOR POR DEFECTO, PORQUE
		// SI!!!!!!!");
	}
	...
	public String toString() {
		...
		return "Persona{" + "nombre=" + this.nombre + ", apellidos=" + this.apellidos + ", dni=" + this.dni + ", edad="
				+ this.edad + '}';

	}

	// Funcion que recibe un DNI y devuelve si es valido o no. OJO no comprueba que
	// la letra sea correcta!
	public static boolean validarDNI(String valor) {
		// Expresion regular que indica 8 digitos y al final alguna de las letras que se
		// permiten
